...
export const contracts: ContractSurface[] = [ComputorControlledFundContract, GeneralQuorumProposalContract, MsVaultContract, NostromoContract, QbayContract, QBondContract, QdrawContract, QearnContract, QIPContract, QswapContract, QuotteryContract, QUtilContract, QVAULTContract, QxContract, RandomContract, RandomLotteryContract];