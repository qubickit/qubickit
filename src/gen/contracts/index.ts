...
import { contract as QRaffleContract } from "./QRaffle";
...
export * as QRaffle from "./QRaffle";
export { contract as QRaffleSurface } from "./QRaffle";
export const contracts: ContractSurface[] = [QxContract, QuotteryContract, RandomContract, QUtilContract, GeneralQuorumProposalContract, ComputorControlledFundContract, QearnContract, QVAULTContract, MsVaultContract, QbayContract, QswapContract, NostromoContract, QdrawContract, RandomLotteryContract, QBondContract, QIPContract, QRaffleContract];